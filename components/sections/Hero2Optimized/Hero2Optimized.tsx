...
const DEFAULT_SUBTITLE = "La page qui transforme l’attention en demandes qualifiées.";
          ...
          <div className="h2-left-section">
            <div className="h2-top-content">
              ...
              <div className="h2-cta-row">
                <CTA kind="secondary" href={secondaryCtaHref ?? realisationsHref}>{secondaryCtaLabel}</CTA>
                <CTA kind="primary" href={primaryCtaHref ?? bookingHref}>{primaryCtaLabel}</CTA>
              </div>
              <Availability />
            </div>
          </div>
