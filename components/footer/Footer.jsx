...
export default function Footer({
  ...
  return <footer className={`footer-reset framer-M7Fsn framer-1e9n470 ${className}`} style={{ "--th1ufy": padding, "--ink": "#fff", backgroundColor: "rgb(35, 38, 48)", ...style }}>
    ...
    <div className="framer-1sjspef">
      ...
      <div className="framer-1j04v13">
        ...
        <div className="framer-1pgssps">{cities.map(location => <p className="footer-place" key={location.citySlug}><a className="footer-link" href={locationRoute(location)}>{location.cityName}</a></p>)}</div>
      </div>
