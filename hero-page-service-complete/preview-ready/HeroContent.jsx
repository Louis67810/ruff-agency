...
function DecorativeRight() {
  return (
    <div className="hero-decoration hero-decoration-right" aria-hidden="true">
      <svg width="100%" height="100%" viewBox="0 0 600 756" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M725.438 363.734L551.782 388.84C400.829 410.663 294.796 244.087 378.467 116.563L396.42 89.2005C414.553 61.5637 443.678 43.0423 476.397 38.3422C590.997 21.8796 655.608 165.733 567.177 240.461L325.066 445.055L25.4385 728.734" stroke="white" strokeOpacity="0.04" strokeWidth="85" strokeLinecap="butt" strokeLinejoin="miter" />
      </svg>
    </div>
  );
}
